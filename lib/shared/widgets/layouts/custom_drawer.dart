...
class CustomDrawerHeader extends BaseStatelessWidget {
  final Widget? child;
...
class CustomDrawerItem extends BaseStatelessWidget {
  final String title;
  final IconData? icon;
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      onTap: onTap,
      selected: selected,
      selectedTileColor: theme.colorScheme.primaryContainer.withAlpha(26),
